fn main(){
    ...
    // determines which additional arguments will be replaced. Arguments start
    ...
    println!("My name is {0}, {1} {0}", "Galen", "Seilis");
    ...
    // For Rust >=1.58, you can directly capture the argument from a
